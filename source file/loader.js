...
(function(){
  ...
  { addr: "Contact us on this Discord: https://discord.gg/UEE39zHuCx", name: "Want to see your server here?" }
        ...
        // --- Epoxy-TLS WebSocket Fallback (Wispcraft) ---
        ...
        function initEpoxy() {
                ...
                epoxyInitPromise = import(EPOXY_CDN).then(function(mod) {
                        return mod.default().then(function() {
                                ...
                                epoxyClient = new mod.EpoxyClient(WISP_URL, opts);
                                EpoxyHandlersClass = mod.EpoxyHandlers;
                                epoxyReady = true;
                                console.log('[EaglerLite] Epoxy-TLS ready (wisp:', WISP_URL + ')');
                        });
                }).catch(function(e) {
                        console.error('[EaglerLite] Epoxy init failed:', e);
                        throw e;
                });
        ...
        function EpoxyWS(url, protocols) {
                ...
                initEpoxy().then(function() {
                        ...
                        if (!EpoxyHandlersClass || !epoxyClient) { self._fail('Epoxy not initialized'); return; }
                ...
                }).catch(function(e) { self._fail('Epoxy init failed'); });
        }
        ...
        function AutoWS(url, protocols) {
                ...
                this._inner.onclose = function(e) {
                        ...
                        } else { self._inner = null; self._tryEpoxy(url, protocols); }
                };
        ...
        AutoWS.prototype._tryEpoxy = function(url, protocols) {
                ...
                ep._dispatch = function(t, e) {
                        ...
                        if (t === 'close') { if (self._dispatchedClose) return; self._dispatchedClose = true; self.readyState = 3; self._closed = true; }
        ...
        console.log('[EaglerLite] Loader WebSocket wrapper installed (direct + Epoxy-TLS fallback)');
})();
